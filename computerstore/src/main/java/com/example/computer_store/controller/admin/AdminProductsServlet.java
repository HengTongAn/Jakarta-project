...
import com.example.computer_store.viewmodel.ProductFormVM;
...
public class AdminProductsServlet extends BaseServlet {
    ...
    private void listProducts(HttpServletRequest request, HttpServletResponse response)
        ...
        forward(request, response, "admin/products.jsp");
    }
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            forwardForm(request, response, productService().get(editId));
    ...
    private void saveProduct(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            forwardForm(request, response, buildTemporaryProduct(request, productId));
    ...
    private void forwardForm(HttpServletRequest request, HttpServletResponse response, Product product)
        ...
        if (product != null) {
            ProductFormVM form = ProductFormVM.fromProduct(product, request.getContextPath());
        ...
        forward(request, response, "admin/product-form.jsp");
    }
