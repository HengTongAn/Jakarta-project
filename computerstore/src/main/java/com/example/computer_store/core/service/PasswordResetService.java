...
import com.example.computer_store.core.repository.PasswordResetTokenRepository;
...
import com.example.computer_store.infrastructure.messaging.EmailUtil;
...
public class PasswordResetService {
    ...
    public void completeReset(String rawToken, String newPassword, String confirmPassword) {
        ...
        try (java.sql.Connection c = com.example.computer_store.infrastructure.persistence.DBConnection.getConnection()) {
