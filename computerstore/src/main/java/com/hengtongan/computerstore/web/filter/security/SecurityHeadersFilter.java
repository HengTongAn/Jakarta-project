...
public class SecurityHeadersFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        // Content Security Policy to restrict resource loading. Assets are
        // vendored locally, so no external CDNs are allowed. 'unsafe-inline'
        // remains for the small inline bootstrapping scripts (CTXPATH,
        // dashboard data) and inline event handlers.
