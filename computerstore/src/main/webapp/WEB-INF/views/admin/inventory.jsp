...
<div class="card-header bg-body fw-semibold">Low stock products (threshold: 5)</div>                <div class="table-responsive">
...
<div class="card-header bg-body d-flex justify-content-between align-items-center gap-2">            <span class="fw-semibold">Adjust stock (all products)</span>
