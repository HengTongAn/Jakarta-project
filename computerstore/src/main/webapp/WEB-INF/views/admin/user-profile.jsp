    ...
    <div class="row g-3">
            ...
            <div class="card card-hover h-100">
                <div class="card-body text-center">
                    ...
                    <div class="d-flex justify-content-center gap-2 mb-3">
                        <span class="badge ${profileUser.role.name() == 'ADMIN' ? 'bg-danger' : 'bg-secondary'}">${profileUser.role.name()}</span>
        ...
        <div class="col-lg-8">
            <div class="card card-hover">
                <div class="card-header bg-white fw-semibold"><i class="bi bi-person-lines-fill me-1 text-brand"></i>Account details</div>
                <div class="card-body">
