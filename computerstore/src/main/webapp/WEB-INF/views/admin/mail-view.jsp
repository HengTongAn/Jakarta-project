...
<div class="container py-4">
    <div class="chat-shell chat-shell-chat">
                ...
                <div>
                    ...
                    <div class="small text-muted">
                        <c:if test="${not empty profile}">
                            @<c:out value="${profile.username}"/> &middot; ${profile.admin ? 'Administrator' : 'Customer'}
                        </c:if>
        ...
        <div class="chat-thread"
             ...
             data-sent="${pageContext.request.contextPath}/admin/mail/sent"
        ...
        <form class="chat-composer" data-no-spinner data-chat-send action="${pageContext.request.contextPath}/admin/mail/compose" method="post">
            <input type="hidden" name="csrfToken" value="${csrfToken}">
