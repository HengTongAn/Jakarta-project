...
<div class="container py-4" data-dashboard>
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="card stats-card">
                <div class="card-body d-flex align-items-center gap-3">
<div class="icon bg-dark bg-opacity-10 text-body"><i class="bi bi-x-circle" aria-hidden="true"></i></div>                    <div><div class="fs-4 fw-bold">${stats.outOfStockCount}</div><div class="small text-muted">Out of stock</div></div>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="card stats-card">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div><div class="fs-4 fw-bold">${stats.pendingReviews}</div><div class="small text-muted">Pending reviews</div></div>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
