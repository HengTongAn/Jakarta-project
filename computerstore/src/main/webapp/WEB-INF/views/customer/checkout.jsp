            ...
            <div class="card card-hover checkout-panel">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label" for="deliveryAddress">Delivery address <span class="text-danger">*</span></label>
                            <textarea id="deliveryAddress" name="deliveryAddress" class="form-control" rows="2" placeholder="House number, street, city" required></textarea>
                            <div class="form-text">Use an address where you can receive the order.</div>
                        </div>
                    </div>
                </div>
            </div>
