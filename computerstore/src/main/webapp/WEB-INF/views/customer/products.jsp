...
<c:if test="${empty activeFilters}">
    ...
    <section class="store-section container" aria-labelledby="featured-title">
        ...
        <div class="row g-4">
            <c:forEach var="p" items="${trending}" end="3"><div class="col-sm-6 col-lg-3"><%@ include file="_productCard.jspf" %></div></c:forEach>
        </div>
    </section>
    ...
    <section class="store-section container pt-3" aria-labelledby="trending-title">
        ...
        <div class="trending-row">
            <c:forEach var="p" items="${trending}"><div class="trending-col"><%@ include file="_productCard.jspf" %></div></c:forEach>
        </div>
    </section>
</c:if>
            ...
            <div class="row g-4">
                <c:forEach var="p" items="${products}">
                    <div class="col-md-4 col-sm-6">
                        <%@ include file="_productCard.jspf" %>
                    </div>
                </c:forEach>
            </div>
        </c:otherwise>
...
<c:if test="${empty activeFilters}">
    ...
    <section class="store-section container" aria-labelledby="new-title">
        ...
        <div class="row g-4">
            <c:forEach var="p" items="${newArrivals}"><div class="col-sm-6 col-lg-3"><%@ include file="_productCard.jspf" %></div></c:forEach>
        </div>
    </section>
