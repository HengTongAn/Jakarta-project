...
<c:set var="pageTitle" value="Message - TechStore"/>
    ...
    <div class="mail-layout">
        ...
        <div class="mail-main p-3">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <a class="btn btn-light btn-sm" href="${pageContext.request.contextPath}/mail">&larr; Inbox</a>
                <div class="d-flex gap-2">
                    ...
                    <c:if test="${isRecipient}">
                        <a class="btn btn-brand btn-sm" href="${pageContext.request.contextPath}/mail/compose?replyTo=${m.messageId}">Reply</a>
                    </c:if>
                </div>
            </div>

            <div class="mail-view-card p-4">
                <h4 class="fw-bold">${empty m.subject ? '' : m.subject}</h4>
